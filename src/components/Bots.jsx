        ...
        <div className="my-2 md:mx-6 flex flex-col items-center justify-center text-base font-yellix-semi">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center">
                ...
                <a
                    ...
                    target='_blank'
                    className={`flex flex-row justify-center gap-2 items-center px-3 no-underline border-[1px] hover:border-tgBlue w-content rounded-full whitespace-nowrap text-base p-2 md:px-3 md:py-2 m-1 ${isDark
                        ? 'border-floWhite text-floWhite'
                        : 'border-floAsh text-floBlack'
                        }`}
                >
