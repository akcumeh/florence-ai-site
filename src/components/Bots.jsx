...
const Bots = () => {
    return (
        <div className="my-2 md:mx-6 flex flex-row justify-center text-base font-yellix-semi">
            <a href="https://wa.me/12164935624/" className=" flex flex-row justify-between gap-1 items-center px-1 no-underline wa border-floAsh border-[1px] hover:border-waGreen w-lrg rounded-full items-center text-base p-1 md:px-3 md:py-2 m-1 items-center">
