...
const FAQLink = () => {
    return (
        <Link to="/faq" className="no-underline">
            <div className="flex items-center justify-center bg-floWhite rounded-full text-[10px] md:text-sm my-4 shadow-sm border-floAsh border-[1px] px-4 py-1 hover:border-floBlue">
